function draw(){  
    ...
    function get_color(base_c){
        ...
        if(selectedColor == '#12221D'){
            darker1 = LightenDarkenColor(base_c,-5);
            darker2 = LightenDarkenColor(base_c,-50);
            darker3 = LightenDarkenColor(base_c,-95);
        }
        else{
...
function get_spacings(panel){
    ...
    function door_area(d_width, d_height, b_color, selectedPanel){
        ...
        if(d_width && d_height){
            ...
            if(selectedGlassType != 'closed'){
                if(selectedPanel == 'Short' || selectedPanel =='Long'){
                    if(selectedWindow){
                        window_call(panel_r_count, panel_count, panel_wdth, panel_spacing, panel_hght, b_edge);
                    }   
                    else{
    ...
    function window_call(p_r_count, panel_count, panel_wdth, panel_spacing, panel_hght, b_edge){
